...
Public Class crtTTStaffWorkload
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Soft.crtTTStaffWorkload.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtTTStaffWorkload
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtTTStaffWorkload = New crtTTStaffWorkload()
        rpt.Site = Me.Site
        Return rpt
    End Function
