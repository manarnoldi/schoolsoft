...
Public Class crtInvIssueNote
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Soft.crtInvIssueNote.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtInvIssueNote
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtInvIssueNote = New crtInvIssueNote()
        rpt.Site = Me.Site
        Return rpt
    End Function
