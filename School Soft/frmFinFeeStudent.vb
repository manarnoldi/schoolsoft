...
Public Class frmFinFeeStudent
    ...
    Private Sub btnLoad_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLoad.Click
        ...
        Try
            ...
            Me.cmdStudFee.Connection = conn
            Me.cmdStudFee.CommandType = CommandType.Text
            Me.cmdStudFee.CommandText = "SELECT * FROM vwStudClass WHERE (className=@className) AND (stream=@stream) AND " & _
    ...
    Private Sub cboFeeCategory_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboFeeCategory.SelectedIndexChanged
        ...
        Try
            ...
            Me.cmdStudFee.Connection = conn
            Me.cmdStudFee.CommandType = CommandType.Text
            Me.cmdStudFee.CommandText = "SELECT * FROM vwFinFeeSetUp WHERE (feeCatName=@feeCatName) AND (className=@className) AND " & _
    ...
    Private Sub cboVwYear_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _
        ...
        If Me.cboVwClass.Text.Trim.Length > 0 And Me.cboVwStream.Text.Trim.Length > 0 And Me.cboVwYear.Text.Trim.Length Then
            Try
                ...
                Me.cmdStudFee.Connection = conn
                Me.cmdStudFee.CommandType = CommandType.Text
                Me.cmdStudFee.CommandText = "SELECT admNo FROM vwStudClass WHERE (className=@className) AND (stream=@stream) AND " & _
    ...
    Private Sub btnVwLoad_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVwLoad.Click
        ...
        Try
            ...
            Me.cmdStudFee.Connection = conn
            Me.cmdStudFee.CommandType = CommandType.Text
            Me.cmdStudFee.CommandText = "SELECT * FROM vwFinFeeStudent WHERE (feeCatName=@feeCatName) AND (className=@className) AND " & _
        ...
        Try
            ...
            For i = 0 To Me.lstStudent.CheckedItems.Count - 1
                ...
                For j = 0 To Me.lstVoteHeads.Items.Count - 1
                    Dim feeCatConflict As Boolean = checkStudFeeCatConflict(Me.lstStudent.CheckedItems(i).Text.Trim, _
                    Me.lstVoteHeads.Items(j).Text.Trim, Me.cboClass.Text.Trim, Me.cboStream.Text.Trim, Me.cboYear.Text.Trim, Me.cboTerm.Text.Trim)
                    If feeCatConflict = True Then
                        MsgBox("Student AdmNo " & Me.lstStudent.CheckedItems(i).Text.Trim _
                               & " Is Already Assigned A different Fee Category.", MsgBoxStyle.Exclamation + _
                               MsgBoxStyle.ApplicationModal + MsgBoxStyle.OkOnly, "Error Detected")
                        Exit Sub
                    End If


                    Dim recordExists As Boolean = checkIfRecordExists(Me.cboClass.Text.Trim, Me.cboStream.Text.Trim, _
                    Me.cboYear.Text.Trim, Me.cboFeeCategory.Text.Trim, Me.cboTerm.Text.Trim, Me.lstVoteHeads.Items(j).Text.Trim, _
    ...
    End Sub
    Private Function checkIfRecordExists(ByVal className As String, ByVal stream As String, ByVal year As Integer, _
    ByVal feeCatName As String, ByVal termName As String, ByVal voteHeadName As String, ByVal admNo As String)
        Dim recordExists As Boolean = False
        Me.cmdStudFee.Connection = conn
        Me.cmdStudFee.CommandType = CommandType.Text
        Me.cmdStudFee.CommandText = "SELECT * FROM vwFinFeeStudent WHERE (className=@className) AND (stream=@stream) " & _
            vbNewLine & " AND (year=@year) AND (feeCatName=@feeCatName) AND (termName=@termName) " & _
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            i = 0
            For i = 0 To Me.lstStudent.CheckedItems.Count - 1
                Dim recordExists As Boolean = checkIfRecordExistsUpdate(Me.cboClass.Text.Trim, Me.cboStream.Text.Trim, Me.cboYear.Text.Trim, _
        ...
        End Try
    End Sub
    Private Function checkIfRecordExistsUpdate(ByVal className As String, ByVal stream As String, ByVal year As Integer, _
    ByVal feeCatName As String, ByVal termName As String, ByVal voteHeadName As String, ByVal admNo As String, ByVal amount As Integer)
        ...
        Return recordExists
    End Function
    Private Function checkStudFeeCatConflict(ByVal admNo As String, ByVal feeCatName As String, ByVal className As String, ByVal stream As String, ByVal year As Integer, ByVal termName As String)
        Dim conflictFound As Boolean = False

        Me.cmdStudFee.Connection = conn
        Me.cmdStudFee.CommandType = CommandType.Text
        Me.cmdStudFee.CommandText = "SELECT admNo,feeCatName FROM vwFinFeeStudent WHERE (admNo=@admNo) AND " & _
    ...
    Private Sub lstVwStudFee_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lstVwStudFee.SelectedIndexChanged

    End Sub

    Private Sub lstStudent_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lstStudent.SelectedIndexChanged
