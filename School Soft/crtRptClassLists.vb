...
Public Class crtRptClassLists
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Soft.crtRptClassLists.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtRptClassLists
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtRptClassLists = New crtRptClassLists()
        rpt.Site = Me.Site
        Return rpt
    End Function
