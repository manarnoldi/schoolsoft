...
Public Class crtTTPrintStaff
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Soft.crtTTPrintStaff.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtTTPrintStaff
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtTTPrintStaff = New crtTTPrintStaff()
        rpt.Site = Me.Site
        Return rpt
    End Function
