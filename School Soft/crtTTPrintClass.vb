...
Public Class crtTTPrintClass
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Soft.crtTTPrintClass.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtTTPrintClass
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtTTPrintClass = New crtTTPrintClass()
        rpt.Site = Me.Site
        Return rpt
    End Function
