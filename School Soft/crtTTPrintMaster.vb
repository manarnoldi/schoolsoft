...
Public Class crtTTPrintMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Soft.crtTTPrintMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtTTPrintMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtTTPrintMaster = New crtTTPrintMaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
