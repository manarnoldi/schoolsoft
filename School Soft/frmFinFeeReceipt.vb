...
Public Class frmFinFeeReceipt
    ...
    Private Sub cboClass_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _
        ...
        If Me.cboYear.Text.Trim.Length > 0 And Me.cboClass.Text.Trim.Length > 0 And Me.cboStream.Text.Trim.Length > 0 Then
            Try
                ...
                Me.cmdFeeReceipt.Connection = conn
                Me.cmdFeeReceipt.CommandType = CommandType.Text
                Me.cmdFeeReceipt.CommandText = "SELECT admNo FROM vwStudClass WHERE (className=@className) " & _
    ...
    Private Sub btnLoadDetails_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLoadDetails.Click
        ...
        Try
            ...
            Me.cmdFeeReceipt.CommandText = "SELECT DISTINCT voteHeadName FROM  vwFinFeeStudent WHERE (className=@className) " & _
            ...
            Me.cmdFeeReceipt.CommandText = "SELECT * FROM  vwFinFeeStudBalance WHERE (className=@className) " & _
            ...
            reader = Me.cmdFeeReceipt.ExecuteReader
            While reader.Read
                Dim actualDate As String = CDate(IIf(DBNull.Value.Equals(reader!actualPayDate), "", reader!actualPayDate)).Day.ToString("00") & " - " & _
                CDate(IIf(DBNull.Value.Equals(reader!actualPayDate), "", reader!actualPayDate)).Month.ToString("00") & " - " & _
            ...
            ElseIf Me.cboTerm.Text.Trim = "TERM 3" Then
                term = "03"
            End If
            Me.cmdFeeReceipt.CommandText = "SELECT ISNULL(MAX(receiptNo),0)+1 AS newRecNo FROM vwFinFeePrevPayments " & _
            ...
            reader = Me.cmdFeeReceipt.ExecuteReader
            While reader.Read
                Me.txtRecNo.Text = "KHSFEE" & Me.cboYear.Text.Trim.Substring(2, 2) & term.Trim & "/" & _
            ...
            Me.cmdFeeReceipt.CommandText = "SELECT * FROM  vwFinFeeStudent WHERE (className=@className) AND (stream=@stream) " & _
    ...
    Private Sub cboPayMode_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboPayMode.SelectedIndexChanged
        Try
            ...
            Me.cmdFeeReceipt.Connection = conn
            Me.cmdFeeReceipt.CommandType = CommandType.Text
            Me.cmdFeeReceipt.CommandText = "SELECT DISTINCT accountNumber FROM tblFinPayAccounts WHERE (modeName=@modeName) " & _
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            If rec > 0 Then
                MsgBox("Fee Received Successfully." & vbNewLine & "Wait For the receipt", MsgBoxStyle.Information + _
