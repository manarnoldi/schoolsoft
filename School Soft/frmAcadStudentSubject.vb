...
Public Class frmAcadStudentSubject
    ...
    Private Sub cboYearUpdate_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboYearUpdate.SelectedIndexChanged, cboStreamUpdate.SelectedIndexChanged, cboClassUpdate.SelectedIndexChanged
        ...
        Try
            ...
            Me.cmdStudSub.CommandType = CommandType.Text
            Me.cmdStudSub.Connection = conn
            Me.cmdStudSub.CommandText = "SELECT * FROM vwStudClass WHERE (studStatus=1) AND (classStatus=1) AND (classStudStatus=1) AND " & _
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        ...
        Try
            ...
            Me.cmdStudSub.CommandType = CommandType.Text
            Me.cmdStudSub.Connection = conn
            Me.cmdStudSub.CommandText = "SELECT * FROM vwAcadStudentSubjects WHERE (className=@className)  AND  " & _
    ...
    Private Sub txtQuickSearchStud_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtQuickSearchStud.TextChanged
        ...
        Try
            ...
            Me.cmdStudSub.CommandType = CommandType.Text
            Me.cmdStudSub.Connection = conn
            Me.cmdStudSub.CommandText = "SELECT * FROM vwAcadStudentSubjects WHERE (FullName LIKE @FullName) " & _
    ...
    Private Function GetStudentSubjectNo(ByVal admNo As String, ByVal className As String, ByVal yearOf As Integer)
        Me.cmdStudSub.Connection = conn
        Me.cmdStudSub.CommandText = "SELECT COUNT(admNo) AS subNo FROM  vwAcadStudentSubjects WHERE (admNo=@admNo)  AND " & _
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            If diffence < 0 Then
                MsgBox("If subjects added for student " & Me.lstStudent.CheckedItems(i).SubItems(1).Text.Trim & " will exceed maximum number of subjects per student." & _
                       vbNewLine & "The student will have " & numberOfSubjects & " Subjects" & _
                       vbNewLine & "Which exceed " & maxNoOfSubjects & " the maximum for class " & _
            ...
            For i = 0 To maxrec
                ...
                For j = 0 To Me.lstSubjectName.CheckedItems.Count - 1
                    ...
                    If recordExists = True Then
                        MsgBox("Entry For Student " & Me.lstStudent.CheckedItems(i).SubItems(1).Text.Trim & " ADM NO " & _
                              Me.lstStudent.CheckedItems(i).Text.Trim & " SUBJECT " & Me.lstSubjectName.CheckedItems(j).Text.Trim & " Not Saved." & _
    ...
    Private Sub checkIfRecordsExist()
        recordExists = True
        Me.cmdStudSub.Connection = conn
        Me.cmdStudSub.CommandText = "SELECT * FROM vwAcadStudentSubjects WHERE  (admNo=@admNo) AND  " & _
