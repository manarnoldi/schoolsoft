...
Public Class crtFinFeeReceipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Soft.crtFinFeeReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtFinFeeReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtFinFeeReceipt = New crtFinFeeReceipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
