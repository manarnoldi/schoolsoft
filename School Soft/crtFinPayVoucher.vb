...
Public Class crtFinPayVoucher
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Soft.crtFinPayVoucher.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtFinPayVoucher
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtFinPayVoucher = New crtFinPayVoucher()
        rpt.Site = Me.Site
        Return rpt
    End Function
